module.exports=function templateEmail(user, bet = [],sum) {
    function generateBets() {      
      let bets = bet.reduce((accumulator, current) => {    
        return (
          accumulator +
          `<tr>
                <td class="colorLeft">Game</td><td class="colorMarked">${current.typeGame}</td>            
              </tr> 
              <tr>
    ...
    >
      ...
      >
        ...
        <div
          ...
          "
        > 
        <p>The player named ${user.name} just made these games:</p>  
